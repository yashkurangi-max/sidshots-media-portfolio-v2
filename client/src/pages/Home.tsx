          ...
          <div className="collage-contact-inner">
            ...
            <div className="collage-contact-grid">
              <div className="collage-contact-copy">
                ...
                <a className="collage-contact-cta" href="mailto:info@sidshotsmedia.in?subject=Book%20a%20shoot%20with%20SIDSHOTS%20MEDIA">Book a Shoot <ArrowUpRight size={16} /></a>
              </div>
